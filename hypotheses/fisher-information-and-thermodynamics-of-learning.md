...
- (0.80) On topic Fisher information and thermodynamics of learning, Prefix Sliding for efficient test-time scaling reports: Test-time scaling uses extra test-time compute to improve performance, such as letting language models reason longer when solving a problem. — [source](http://arxiv.org/abs/2608.26070v1)
- (0.75) On topic Fisher information and thermodynamics of learning, Private communication via zero-private-capacity quantum channels reports: Private communication over a noisy quantum channel requires reliable transmission to the receiver and secrecy from the environment. — [source](http://arxiv.org/abs/2609.10520v1)
