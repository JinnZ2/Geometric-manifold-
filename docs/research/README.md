...
| `OPEN_QUESTIONS.md` | This repo | Six questions to be settled by measurement rather than preference, each with a named experiment and an honest status. Q2 now answered, Q5 tested, Q1/Q4 open. |
